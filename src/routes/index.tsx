...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      {
        title:
          "Brook of Destiny Foundation — Nurturing Destinies, Transforming Communities",
      },
    ],
  }),
});
    ...
    <>
      ...
      <section className="relative isolate min-h-[88dvh] overflow-hidden bg-forest-deep text-cream">
        ...
        <img
          ...
          className="absolute left-1/2 top-24 z-10 w-56 -translate-x-1/2 object-contain sm:left-8 sm:top-24 sm:w-64 sm:translate-x-0 md:left-10 md:w-72 lg:left-12 lg:w-80"
        />
          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-sm leading-relaxed text-muted">
                Brook of Destiny Foundation is rooted in Bungoma, Kenya, with
                a vision that reaches beyond borders. From our local
                foundation, we work to respond to human needs, nurture
                potential, restore hope, and create opportunities for children,
          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-sm leading-relaxed text-muted">
                ...
                psychosocial support, livelihoods, and community development,
                we seek to turn compassion into practical action and faith
          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-sm leading-relaxed text-muted">
                ...
                development organizations, foundations, businesses, and
                partners who share our commitment to transforming lives and
        ...
        <div className="mx-auto grid max-w-6xl items-center gap-10 px-4 py-16 sm:px-6 lg:grid-cols-2">
          ...
          <div>
            ...
            <p className="mt-5 text-cream/85">
              Our team and volunteers walk village paths in reflective
              jackets — not as visitors passing through, but as neighbours.
              Health outreach, homestead visits, and youth circles are how
              destinies are actually nurtured.
            </p>
        ...
        <div className="mt-10 grid gap-6 sm:grid-cols-2">
          ...
          <div className="overflow-hidden rounded-2xl shadow-soft">
            ...
            <div className="bg-card p-4">
              ...
              <p className="mt-1 text-sm text-muted">
                A look at our Education & Scholarships programme in Bungoma.
              </p>
            </div>
          </div>
          ...
          <div className="overflow-hidden rounded-2xl shadow-soft">
            ...
            <div className="bg-card p-4">
              ...
              <p className="mt-1 text-sm text-muted">
                Another glimpse into the day-to-day work of Brook of Destiny
                Foundation.
              </p>
            </div>
          </div>
          ...
          <div className="overflow-hidden rounded-2xl shadow-soft">
            ...
            <div className="bg-card p-4">
              ...
              <p className="mt-1 text-sm text-muted">
                Our staff and volunteers building trust and unity behind the
                scenes.
              </p>
            </div>
          </div>
